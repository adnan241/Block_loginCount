...
/**
 * Version information for the block_logincounter plugin.
 *
...
$plugin->version   = 2024082104;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  =  2024042202;        // Requires this Moodle version.
$plugin->component = 'block_logincounter'; // Full name of the plugin (used for diagnostics).
$plugin->maturity  = MATURITY_STABLE;   // This is a stable version.
$plugin->release   = 'v1.0';            // This is the release version.