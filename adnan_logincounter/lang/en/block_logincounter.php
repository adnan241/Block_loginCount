...
/**
 * English language strings for block_logincounter.
 *
 * @package   block_logincounter
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'Login Counter';
$string['login_count'] = 'Login Count: {$a}';
$string['userid'] = 'User ID: {$a}';
$string['username'] = 'Username: {$a}';
$string['name'] = 'Name: {$a}';
$string['lastlogin'] = 'Last Login: {$a}';
